...
import { F as Ge } from "./FieldsQueryParam-Z-S0qGe1.js";
function Fe(s, l, n) {
    const i = s.slice();
    return (i[5] = l[n]), i;
}
    ...
    return {
        ...
        c() {
            (n = o("button")),
                ...
                (g = h()),
                p(n, "class", "tab-item"),
                X(n, "active", l[1] === l[5].code),
                (this.first = n);
        },
        m(v, O) {
            c(v, n, O), a(n, f), a(n, g), d || ((b = Xe(n, "click", k)), (d = !0));
        },
        p(v, O) {
            (l = v),
                O & 4 && i !== (i = l[5].code + "") && pe(f, i),
                O & 6 && X(n, "active", l[1] === l[5].code);
        },
        d(v) {
            v && r(n), (d = !1), b();
        },
...
function Ve(s, l) {
    let n, i, f, g;
    return (
        (i = new je({ props: { content: l[5].body } })),
        {
            key: s,
            first: null,
            c() {
            ...
            m(d, b) {
                c(d, n, b), z(i, n, null), a(n, f), (g = !0);
            },
            p(d, b) {
                l = d;
                const k = {};
                b & 4 && (k.content = l[5].body),
                    i.$set(k),
                    (!g || b & 6) && X(n, "active", l[1] === l[5].code);
            },
            i(d) {
                g || (J(i.$$.fragment, d), (g = !0));
            },
            o(d) {
                j(i.$$.fragment, d), (g = !1);
            },
...
function Ye(s) {
    ...
    `,
        ...
        (C = new je({ props: { content: "?expand=relField1,relField2.subRelField" } })),
        (q = new Ge({ props: { prefix: "record." } }));
    let I = Q(s[2]);
    const Me = (e) => e[5].code;
    ...
    return {
        c() {
            (l = o("h3")),
                (n = _("Auth with OAuth2 (")),
                (f = _(i)),
                (g = _(")")),
                (d = h()),
                (b = o("div")),
                (b.innerHTML = `<p>Authenticate with an OAuth2 provider and returns a new auth token and record data.</p> <p>For more details please check the
        <a href="https://pgbase.io/docs/authentication#authenticate-with-oauth2" target="_blank" rel="noopener noreferrer">OAuth2 integration documentation
        </a>.</p>`),
                (k = h()),
                K(v.$$.fragment),
                (O = h()),
                (R = o("h6")),
                (R.textContent = "API details"),
                (G = h()),
                (A = o("div")),
                (x = o("strong")),
                (x.textContent = "POST"),
                ...
                (E = o("div")),
                (P = o("p")),
                (me = _("/api/collections/")),
                (Y = o("strong")),
                (ee = _(N)),
                (fe = _("/auth-with-oauth2")),
                (te = h()),
                (M = o("div")),
                (M.textContent = "Body Parameters"),
                (ae = h()),
                (W = o("table")),
                (W.innerHTML = `<thead><tr><th>Param</th> <th>Type</th> <th width="50%">Description</th></tr></thead> <tbody><tr><td><div class="inline-flex"><span class="label label-success">Required</span> <span>provider</span></div></td> <td><span class="label">String</span></td> <td>The name of the OAuth2 client provider (eg. &quot;google&quot;).</td></tr> <tr><td><div class="inline-flex"><span class="label label-success">Required</span> <span>code</span></div></td> <td><span class="label">String</span></td> <td>The authorization code returned from the initial request.</td></tr> <tr><td><div class="inline-flex"><span class="label label-success">Required</span> <span>codeVerifier</span></div></td> <td><span class="label">String</span></td> <td>The code verifier sent with the initial request as part of the code_challenge.</td></tr> <tr><td><div class="inline-flex"><span class="label label-success">Required</span> <span>redirectURL</span></div></td> <td><span class="label">String</span></td> <td>The redirect url sent with the initial request.</td></tr> <tr><td><div class="inline-flex"><span class="label label-warning">Optional</span> <span>createData</span></div></td> <td><span class="label">Object</span></td> <td><p>Optional data that will be used when creating the auth record on OAuth2 sign-up.</p> <p>The created auth record must comply with the same requirements and validations in the
                    ...
                    <br/> <em>The data can only be in <code>json</code>, aka. <code>multipart/form-data</code> and files
                        upload currently are not supported during OAuth2 sign-ups.</em></p></td></tr></tbody>`),
                (le = h()),
                (U = o("div")),
                (U.textContent = "Query parameters"),
                (ne = h()),
                (y = o("table")),
                (oe = o("thead")),
                (oe.innerHTML = '<tr><th>Param</th> <th>Type</th> <th width="60%">Description</th></tr>'),
                (ge = h()),
                (B = o("tbody")),
                (S = o("tr")),
                (se = o("td")),
                (se.textContent = "expand"),
                (_e = h()),
                (ie = o("td")),
                (ie.innerHTML = '<span class="label">String</span>'),
                (ke = h()),
                (m = o("td")),
                (ve = _(`Auto expand record relations. Ex.:
                `)),
                K(C.$$.fragment),
                (we = _(`
                ...
                `)),
                (re = o("code")),
                (re.textContent = "expand"),
                (Ae = _(" property (eg. ")),
                (ce = o("code")),
                (ce.textContent = '"expand": {"relField1": {...}, ...}'),
                (ye = _(`).
                `)),
                (Se = o("br")),
                (Te = _(`
                ...
                (de = o("strong")),
                (de.textContent = "view"),
                (Ce = _(" will be expanded.")),
                (qe = h()),
                K(q.$$.fragment),
                (ue = h()),
                (F = o("div")),
                (F.textContent = "Responses"),
                (he = h()),
                (T = o("div")),
                (L = o("div"));
            ...
            p(l, "class", "m-b-sm"),
                p(b, "class", "content txt-lg m-b-sm"),
                p(R, "class", "m-b-xs"),
                p(x, "class", "label label-primary"),
                p(E, "class", "content"),
                p(A, "class", "alert alert-success"),
                p(M, "class", "section-title"),
                p(W, "class", "table-compact table-border m-b-base"),
                p(U, "class", "section-title"),
                p(y, "class", "table-compact table-border m-b-base"),
                p(F, "class", "section-title"),
                p(L, "class", "tabs-header compact combined left"),
                p(H, "class", "tabs-content"),
                p(T, "class", "tabs");
        },
        m(e, t) {
            c(e, l, t),
                ...
                c(e, T, t),
                a(T, L);
            for (let u = 0; u < $.length; u += 1) $[u] && $[u].m(L, null);
            a(T, Re), a(T, H);
            for (let u = 0; u < w.length; u += 1) w[u] && w[u].m(H, null);
            D = !0;
        },
        p(e, [t]) {
            (!D || t & 1) && i !== (i = e[0].name + "") && pe(f, i);
            const u = {};
            t & 9 &&
                (u.js = `
        import PocketBase from 'pgbase';
    ...
    `),
                v.$set(u),
                (!D || t & 1) && N !== (N = e[0].name + "") && pe(ee, N),
                t & 6 && ((I = Q(e[2])), ($ = Ue($, t, Me, 1, e, I, De, L, Ie, He, null, Le))),
                t & 6 && ((V = Q(e[2])), Qe(), (w = Ue(w, t, We, 1, e, V, Pe, H, Ze, Ve, null, Fe)), ze());
        },
        i(e) {
            if (!D) {
                J(v.$$.fragment, e), J(C.$$.fragment, e), J(q.$$.fragment, e);
                for (let t = 0; t < V.length; t += 1) J(w[t]);
                D = !0;
            }
        },
        o(e) {
            j(v.$$.fragment, e), j(C.$$.fragment, e), j(q.$$.fragment, e);
            for (let t = 0; t < w.length; t += 1) j(w[t]);
            D = !1;
        },
        d(e) {
            e &&
...
function et(s, l, n) {
    let i,
        ...
        g = 200,
        d = [];
    const b = (k) => n(1, (g = k.code));
    return (
        (s.$$set = (k) => {
            "collection" in k && n(0, (f = k.collection));
        }),
        (s.$$.update = () => {
            s.$$.dirty & 1 &&
                n(
                            ...
                            body: JSON.stringify(
                                {
                                    ...
                                    record: Be.dummyCollectionRecord(f),
                                    meta: {
                                        id: "abc123",
                                        name: "John Doe",
                                        username: "john.doe",
        ...
        n(3, (i = Be.getApiExampleUrl(Ke.baseURL))),
        [f, g, d, i, b]
    );
}
class lt extends Je {
    constructor(l) {
        super(), xe(this, l, et, Ye, Ee, { collection: 0 });
    }
}
