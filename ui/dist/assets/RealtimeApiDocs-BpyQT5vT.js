...
function he(o) {
        ...
        (r = new ue({
            props: {
                content: JSON.stringify(
                    { action: "create", record: P.dummyCollectionRecord(o[0]) },
                    null,
                    2,
        ...
        })),
        {
            c() {
                (i = p("h3")),
                    ...
                    (k = a()),
                    (h = p("div")),
                    (h.innerHTML = `<p>Subscribe to realtime changes via Server-Sent Events (SSE).</p> <p>Events are sent for <strong>create</strong>, <strong>update</strong>
        and <strong>delete</strong> record operations (see &quot;Event data format&quot; section below).</p>`),
                    (D = a()),
                    (f = p("div")),
                    (f.innerHTML = `<div class="icon"><i class="ri-information-line"></i></div> <div class="contet"><p><strong>You could subscribe to a single record or to an entire collection.</strong></p> <p>When you subscribe to a <strong>single record</strong>, the collection&#39;s
            ...
            event message.</p></div>`),
                    ...
                    (S = a()),
                    ($ = p("h6")),
                    ($.textContent = "API details"),
                    (w = a()),
                    (g = p("div")),
                    (g.innerHTML =
                        '<strong class="label label-primary">SSE</strong> <div class="content"><p>/api/realtime</p></div>'),
                    (C = a()),
                    (v = p("div")),
                    (v.textContent = "Event data format"),
                    (E = a()),
                    le(r.$$.fragment),
                    u(i, "class", "m-b-sm"),
                    u(h, "class", "content txt-lg m-b-sm"),
                    u(f, "class", "alert alert-info m-t-10 m-b-sm"),
                    u($, "class", "m-b-xs"),
                    u(g, "class", "alert"),
                    u(v, "class", "section-title");
            },
            m(e, t) {
                n(e, i, t),
                    y(i, m),
            ...
            p(e, [t]) {
                var Y, z, F, G, K, Q, X, Z, x, ee, te, oe;
                (!R || t & 1) && c !== (c = e[0].name + "") && me(b, c);
                const O = {};
                t & 3 &&
                    (O.js = `
        import PocketBase from 'pgbase';
    ...
    `),
                ...
                const V = {};
                t & 1 &&
                    (V.content = JSON.stringify(
                        { action: "create", record: P.dummyCollectionRecord(e[0]) },
                        null,
                        2,
                    ).replace('"action": "create"', '"action": "create" // create, update or delete')),
                    r.$set(V);
            ...
            i(e) {
                R || (ie(l.$$.fragment, e), ie(r.$$.fragment, e), (R = !0));
            },
            o(e) {
                ne(l.$$.fragment, e), ne(r.$$.fragment, e), (R = !1);
            },
            d(e) {
                e && (s(i), s(k), s(h), s(D), s(f), s(_), s(S), s($), s(w), s(g), s(C), s(v), s(E)),
                    se(l, e),
                    se(r, e);
            },
        }
...
function fe(o, i, m) {
    ...
    return (
        (o.$$set = (d) => {
            "collection" in d && m(0, (b = d.collection));
        }),
        m(1, (c = P.getApiExampleUrl(de.baseURL))),
        [b, c]
    );
}
class ge extends re {
    constructor(i) {
        super(), ae(this, i, fe, he, be, { collection: 0 });
    }
}
